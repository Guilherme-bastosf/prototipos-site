...
const LOJA = {
  nome: "iPhone Rio",
  nomeDestaque: "Rio",
  slogan: "iPhones originais com entrega em shopping no RJ",
  descricao: "iPhones originais com nota fiscal no nome do cliente. Entregas em shopping RJ. Ate 18x sem juros. Pague somente na entrega.",

  instagram: "iphone_rio",
  instagramUrl: "https://instagram.com/iphone_rio",
  whatsapp: "5521992185522",
  whatsappLink: "https://wa.me/5521992185522",
  whatsappMsg: "Ola! Vi o catalogo online do iPhone Rio e tenho interesse em um produto!",

  seguidores: "151 mil",
  clientesSatisfeitos: "10.000+",
  ...
  diferenciais: [
    { icone: "fa-file-invoice", texto: "NF no Seu Nome" },
    { icone: "fa-shield-halved", texto: "iPhone Original" },
    { icone: "fa-credit-card", texto: "18x Sem Juros" },
    { icone: "fa-store", texto: "Entrega em Shopping" },
    { icone: "fa-hand-holding-dollar", texto: "Pague na Entrega" },
    { icone: "fa-whatsapp", texto: "Vendas WhatsApp" }
  ],

  depoimentos: [
    { nome: "Lucas M.", texto: "Comprei meu iPhone 15 Pro lacrado, NF no meu nome. Atendimento 10/10! Super recomendo o iPhone Rio.", estrelas: 5, tempo: "2 semanas atras" },
    { nome: "Amanda S.", texto: "Fiz upgrade do meu iPhone 12 pro 16. Processo rapido, paguei so na entrega no shopping. Seguranca total!", estrelas: 5, tempo: "1 mes atras" },
    { nome: "Rafael O.", texto: "Melhor preco que encontrei no RJ inteiro. 18x sem juros de verdade. Entrega perfeita no shopping.", estrelas: 5, tempo: "3 semanas atras" },
    { nome: "Juliana P.", texto: "Segundo iPhone que compro com eles. 151 mil seguidores nao mentem. Confianca total!", estrelas: 5, tempo: "1 mes atras" },
    { nome: "Pedro H.", texto: "Peguei um seminovo em estado impecavel. Conferi tudo na hora da entrega. Zero stress.", estrelas: 5, tempo: "2 semanas atras" },
    { nome: "Carla R.", texto: "Comprei pelo WhatsApp, entregaram no shopping, conferi e paguei. Simples assim. iPhone original com NF.", estrelas: 5, tempo: "1 semana atras" }
  ],

  faq: [
    { p: "Os produtos tem nota fiscal?", r: "Sim! Todos emitimos NF no nome do cliente." },
    { p: "Como funciona o parcelamento?", r: "Ate 18x sem juros no cartao de credito." },
    { p: "Como funciona a entrega?", r: "Entregamos em shoppings do RJ. Voce confere o produto e so paga na hora." },
    { p: "Os iPhones sao originais?", r: "Sim! Todos originais Apple com nota fiscal e garantia." },
    { p: "Os seminovos tem garantia?", r: "Sim! Todos passam por inspecao e possuem garantia." },
    { p: "Posso pagar na entrega?", r: "Sim! So paga quando conferir. Pix, cartao ou dinheiro." }
  ],
