...
const LOJA = {
  nome: "iHome Connect",
  nomeDestaque: "Connect",
  slogan: "Seu iPhone dos sonhos, a um toque de distância",
  descricao: "Celulares novos e seminovos com nota fiscal, garantia e as melhores condições do RJ. Entregas em Shopping RJ. Parcelamos em até 18x.",

  instagram: "ihome_connect",
  instagramUrl: "https://instagram.com/ihome_connect",
  whatsapp: "5521999999999",
  whatsappLink: "https://wa.me/5521999999999",
  whatsappMsg: "Olá! Vi o catálogo online e tenho interesse em um produto! 📱",
  ...
  diferenciais: [
    ...
    { icone: "fa-credit-card", texto: "Até 18x" },
    { icone: "fa-truck-fast", texto: "Entrega Shopping RJ" },
    { icone: "fa-mobile-screen", texto: "Aceitamos Trade-in" },
    { icone: "fa-hand-holding-dollar", texto: "Pgto na Entrega" }
  ],

  depoimentos: [
    { nome: "Lucas M.", texto: "Comprei meu iPhone 15 Pro lacrado, com NF e tudo certinho. Atendimento 10/10! Super recomendo a iHome Connect.", estrelas: 5, tempo: "2 semanas atrás" },
    { nome: "Amanda S.", texto: "Fiz trade-in do meu iPhone 12 e saiu muito em conta o upgrade pro 16. Processo super rápido e seguro!", estrelas: 5, tempo: "1 mês atrás" },
    { nome: "Rafael O.", texto: "Melhor preço que encontrei no RJ inteiro. Parcela em 18x e ainda entregam no shopping. Nota mil!", estrelas: 5, tempo: "3 semanas atrás" },
    { nome: "Juliana P.", texto: "Segundo iPhone que compro com eles. Confiança total, produto sempre confere com o anunciado. Top demais!", estrelas: 5, tempo: "1 mês atrás" },
    { nome: "Pedro H.", texto: "Peguei um seminovo em estado impecável. Bateria 100%, zero risco. Entrega rápida e atenciosa.", estrelas: 5, tempo: "2 semanas atrás" },
    { nome: "Carla R.", texto: "Minha mãe queria um iPhone e eu estava com medo de comprar online. Fui super bem atendida, chegou lacrado, com NF. Amei!", estrelas: 5, tempo: "1 semana atrás" }
  ],

  faq: [
    { p: "Os produtos têm nota fiscal?", r: "Sim! Todos os nossos produtos, tanto novos quanto seminovos, acompanham nota fiscal eletrônica." },
    { p: "Como funciona o parcelamento em até 18x?", r: "Parcelamos no cartão de crédito em até 18x. O valor das parcelas é calculado automaticamente no catálogo. Consulte condições especiais via WhatsApp!" },
    { p: "Vocês aceitam meu iPhone usado como entrada?", r: "Sim! Fazemos avaliação do seu aparelho e abatemos o valor na compra do novo. Chame no WhatsApp para uma cotação rápida." },
    { p: "Como funciona a entrega?", r: "Entregamos em mãos em Shoppings do RJ com total segurança. Você confere o produto antes de finalizar o pagamento." },
    { p: "Os seminovos têm garantia?", r: "Sim! Todos os seminovos passam por nossa inspeção completa e possuem garantia de funcionamento." },
    { p: "Posso pagar na entrega?", r: "Sim! Aceitamos pagamento no ato da entrega via Pix, cartão ou dinheiro. Você só paga quando conferir o produto." }
  ],

  adminSenha: "ihome2026",
...
const CATALOGO_PADRAO = [
  ...
  },
  {
    ...
    cores:[
      {nome:"Titânio Natural",hex:"#C2B8A3",img:"img/iphone-16-pro.jpg"},
      {nome:"Titânio Deserto",hex:"#BFA48E",img:"https://store.storeimages.cdn-apple.com/4982/as-images.apple.com/is/iphone-16-pro-desert-select-202409?wid=470&hei=556&fmt=png-alpha"},
      {nome:"Titânio Preto",hex:"#3C3B3F",img:"https://store.storeimages.cdn-apple.com/4982/as-images.apple.com/is/iphone-16-pro-black-select-202409?wid=470&hei=556&fmt=png-alpha"},
      {nome:"Titânio Branco",hex:"#F2F1EB",img:"https://store.storeimages.cdn-apple.com/4982/as-images.apple.com/is/iphone-16-pro-white-select-202409?wid=470&hei=556&fmt=png-alpha"}
    ],
    memorias:[
  ...
  },
  {
    ...
    cores:[
      {nome:"Titânio Natural",hex:"#C2B8A3",img:"img/iphone-16-pro-max.jpg"},
      {nome:"Titânio Deserto",hex:"#BFA48E",img:"https://store.storeimages.cdn-apple.com/4982/as-images.apple.com/is/iphone-16-pro-desert-select-202409?wid=470&hei=556&fmt=png-alpha"},
      {nome:"Titânio Preto",hex:"#3C3B3F",img:"https://store.storeimages.cdn-apple.com/4982/as-images.apple.com/is/iphone-16-pro-black-select-202409?wid=470&hei=556&fmt=png-alpha"},
      {nome:"Titânio Branco",hex:"#F2F1EB",img:"https://store.storeimages.cdn-apple.com/4982/as-images.apple.com/is/iphone-16-pro-white-select-202409?wid=470&hei=556&fmt=png-alpha"}
    ],
  ...
  },
  {
    ...
    cores:[
      {nome:"Prateado",hex:"#E0E0E0",img:"img/iphone-17-pro-max.png"},
      {nome:"Laranja Cósmico",hex:"#D4764A",img:"https://store.storeimages.cdn-apple.com/1/as-images.apple.com/is/iphone-17-pro-finish-cosmicorange-202509?wid=470&hei=556&fmt=png-alpha"},
      {nome:"Azul Intenso",hex:"#2A4B7C",img:"https://store.storeimages.cdn-apple.com/1/as-images.apple.com/is/iphone-17-pro-finish-deepblue-202509?wid=470&hei=556&fmt=png-alpha"}
    ],
    memorias:[
  ...
  // ─── APPLE WATCH ──────────────────────────────────────
  {
    ...
    cores:[
      {nome:"Meia-noite",hex:"#1C1C1E",img:"https://store.storeimages.cdn-apple.com/1/as-images.apple.com/is/watch-se3-702-702-aluminum-midnight-sport-band-midnight-202503?wid=400&hei=400&fmt=png-alpha"},
      {nome:"Estelar",hex:"#F5E6CE",img:"https://store.storeimages.cdn-apple.com/1/as-images.apple.com/is/watch-se3-702-702-aluminum-starlight-sport-band-starlight-202503?wid=400&hei=400&fmt=png-alpha"}
    ],
  ...
  },
  {
    ...
    cores:[
      {nome:"Cinza Espacial",hex:"#6B6B6F",img:"https://www.apple.com/newsroom/images/2025/09/apple-debuts-apple-watch-series-11-featuring-groundbreaking-health-insights/article/Apple-Watch-Series-11-aluminum-space-gray-250909_inline.jpg.large.jpg"},
      {nome:"Prateado",hex:"#E0E0E0",img:"https://www.apple.com/newsroom/images/2025/09/apple-debuts-apple-watch-series-11-featuring-groundbreaking-health-insights/article/Apple-Watch-Series-11-aluminum-silver-250909_inline.jpg.large.jpg"},
      {nome:"Rose",hex:"#E8CDBE",img:"https://www.apple.com/newsroom/images/2025/09/apple-debuts-apple-watch-series-11-featuring-groundbreaking-health-insights/article/Apple-Watch-Series-11-aluminum-rose-gold-250909_inline.jpg.large.jpg"}
    ],
  ...
  },
  {
    ...
    cores:[
      {nome:"Titânio Natural",hex:"#C2B8A3",img:"https://store.storeimages.cdn-apple.com/1/as-images.apple.com/is/watch-ultra3-702-702-titanium-natural-trail-loop-orangegray-202509?wid=400&hei=400&fmt=png-alpha"},
      {nome:"Titânio Preto",hex:"#3C3B3F",img:"https://store.storeimages.cdn-apple.com/1/as-images.apple.com/is/watch-ultra3-702-702-titanium-black-trail-loop-blackgray-202509?wid=400&hei=400&fmt=png-alpha"}
    ],
