...
const LOJA = {
  nome: "Elite Suporte",
  nomeDestaque: "Suporte",
  slogan: "Ha 15 anos referencia Apple no RJ",
  descricao: "iPhone novos e seminovos. 15 anos referencia Apple. +30.000 clientes. Entrega gratis RJ. Campo Grande.",
  instagram: "elitesuporte",
  instagramUrl: "https://instagram.com/elitesuporte",
  whatsapp: "5521999999999",
  whatsappLink: "https://wa.me/5521999999999",
  whatsappMsg: "Ola! Vi o catalogo online e tenho interesse em um produto!",
  seguidores: "45.4 mil",
  clientesSatisfeitos: "30.000+",
  cores: {primaria:"#FF5722",secundaria:"#E64A19",accent:"#FF8A65",grad1:"#FF5722",grad2:"#BF360C"},
  diferenciais: [{icone:"fa-calendar-check",texto:"15 Anos no Mercado"},{icone:"fa-users",texto:"+30 Mil Clientes"},{icone:"fa-credit-card",texto:"Ate 18x"},{icone:"fa-truck-fast",texto:"Entrega Gratis RJ"},{icone:"fa-mobile-screen",texto:"Aceitamos Troca"},{icone:"fa-wrench",texto:"Suporte Tecnico"}],
  depoimentos: [
