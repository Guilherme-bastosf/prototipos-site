...
const LOJA = {
  nome: "Dream Express",
  nomeDestaque: "Express",
  slogan: "iPhones e Produtos Apple com 1 ano de garantia",
  descricao: "iPhones e Produtos Apple. 1 ano de garantia. Loja fisica + entregas RJ. Pague so na entrega. Atendimento ate 00h.",
  instagram: "dreamexpress.rj",
  instagramUrl: "https://instagram.com/dreamexpress.rj",
  whatsapp: "5521999999999",
  whatsappLink: "https://wa.me/5521999999999",
  whatsappMsg: "Ola! Vi o catalogo online e tenho interesse em um produto!",
  seguidores: "300 mil",
  clientesSatisfeitos: "20.000+",
  cores: {primaria:"#2196F3",secundaria:"#1565C0",accent:"#64B5F6",grad1:"#2196F3",grad2:"#0D47A1"},
  diferenciais: [{icone:"fa-shield-halved",texto:"1 Ano de Garantia"},{icone:"fa-store",texto:"Loja Fisica"},{icone:"fa-truck-fast",texto:"Entregas no RJ"},{icone:"fa-hand-holding-dollar",texto:"Pague na Entrega"},{icone:"fa-clock",texto:"Atendimento ate 00h"},{icone:"fa-credit-card",texto:"Ate 18x"}],
  depoimentos: [
    {nome:"Lucas M.",texto:"Comprei meu iPhone 15 Pro lacrado. Atendimento 10/10! Super recomendo.",estrelas:5,tempo:"2 semanas atras"},
    {nome:"Amanda S.",texto:"Fiz trade-in e saiu muito em conta o upgrade. Processo rapido e seguro!",estrelas:5,tempo:"1 mes atras"},
    {nome:"Rafael O.",texto:"Melhor preco que encontrei. Parcela em 18x e entrega perfeita.",estrelas:5,tempo:"3 semanas atras"},
    {nome:"Juliana P.",texto:"Segundo iPhone que compro. Confianca total, produto confere.",estrelas:5,tempo:"1 mes atras"},
    {nome:"Pedro H.",texto:"Seminovo impecavel. Bateria 100%, zero risco. Entrega rapida.",estrelas:5,tempo:"2 semanas atras"},
    {nome:"Carla R.",texto:"Fui super bem atendida, chegou lacrado, com NF. Amei!",estrelas:5,tempo:"1 semana atras"}
  ],
  faq: [
    {p:"Os produtos tem nota fiscal?",r:"Sim! Todos acompanham nota fiscal eletronica."},
    {p:"Parcelam em quantas vezes?",r:"Ate 18x no cartao de credito."},
    {p:"Aceitam iPhone usado?",r:"Sim! Avaliamos e abatemos na compra do novo."},
    {p:"Como funciona a entrega?",r:"Entregamos no RJ. Voce confere antes de pagar."},
    {p:"Os seminovos tem garantia?",r:"Sim! Todos com inspecao completa e garantia."},
    {p:"Posso pagar na entrega?",r:"Sim! Pix, cartao ou dinheiro."}
  ],
  adminSenha: "dream2026",
