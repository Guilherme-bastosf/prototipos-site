...
const LOJA = {
  nome: "MS Imports",
  nomeDestaque: "Imports",
  slogan: "Referencia em iPhones desde 2019",
  descricao: "iPhone, MacBook e iPad novos e seminovos. Desde 2019 levando seguranca e os melhores precos. Aceitamos seu iPhone na troca. Pagamento no ato da entrega.",

  instagram: "m_s.imports",
  instagramUrl: "https://instagram.com/m_s.imports",
  whatsapp: "5521999999999",
  whatsappLink: "https://wa.me/5521999999999",
  whatsappMsg: "Ola! Vi o catalogo online da MS Imports e tenho interesse em um produto!",
  ...
  diferenciais: [
    { icone: "fa-calendar-check", texto: "Desde 2019" },
    { icone: "fa-shield-halved", texto: "Garantia" },
    { icone: "fa-credit-card", texto: "Ate 18x" },
    { icone: "fa-lock", texto: "Compra Segura" },
    { icone: "fa-mobile-screen", texto: "Aceitamos Troca" },
    { icone: "fa-hand-holding-dollar", texto: "Pgto na Entrega" }
  ],

  depoimentos: [
    { nome: "Lucas M.", texto: "Comprei meu iPhone 15 Pro lacrado, com NF e tudo certinho. Atendimento 10/10! Super recomendo a MS Imports.", estrelas: 5, tempo: "2 semanas atras" },
    ...
    { nome: "Rafael O.", texto: "Referencia no mercado. Compro desde 2020 e nunca tive problema. Parcela em 18x, entrega perfeita.", estrelas: 5, tempo: "3 semanas atras" },
    ...
    { nome: "Pedro H.", texto: "Peguei um seminovo em estado impecavel. Bateria 100%, zero risco. Entrega rapida e atenciosa.", estrelas: 5, tempo: "2 semanas atras" },
    { nome: "Carla R.", texto: "Comprei um MacBook pela MS Imports e veio perfeito. Desde 2019 no mercado, confianca total.", estrelas: 5, tempo: "1 semana atras" }
  ],
  ...
  faq: [
    ...
    { p: "Como funciona o parcelamento em ate 18x?", r: "Parcelamos no cartao de credito em ate 18x. Consulte condicoes especiais via WhatsApp!" },
    { p: "Voces aceitam meu iPhone usado como entrada?", r: "Sim! Fazemos avaliacao do seu aparelho e abatemos o valor na compra do novo. Chame no WhatsApp!" },
    { p: "Como funciona a entrega?", r: "Pagamento no ato da entrega. Voce confere o produto antes de finalizar." },
    { p: "Os seminovos tem garantia?", r: "Sim! Todos os seminovos passam por inspecao completa e possuem garantia." },
    { p: "Posso pagar na entrega?", r: "Sim! Aceitamos Pix, cartao ou dinheiro. Voce so paga quando conferir o produto." }
  ],
