...
const LOJA = {
  nome: "Top iPhones",
  nomeDestaque: "iPhones",
  slogan: "iPhone em Angra dos Reis com garantia e procedencia",
  descricao: "Loja especializada em produtos Apple em Angra dos Reis. Aceitamos seu iPhone de entrada, parcelamos em ate 18x no cartao. Rua da Conceicao, 309.",

  instagram: "topiphonnes",
  instagramUrl: "https://instagram.com/topiphonnes",
  whatsapp: "5521999999999",
  whatsappLink: "https://wa.me/5521999999999",
  whatsappMsg: "Ola! Vi o catalogo online da Top iPhones e tenho interesse em um produto!",

  seguidores: "10.2 mil",
  clientesSatisfeitos: "1.000+",
  ...
  diferenciais: [
    ...
    { icone: "fa-location-dot", texto: "Angra dos Reis - RJ" },
    { icone: "fa-mobile-screen", texto: "Aceitamos Seu iPhone" },
    { icone: "fa-hand-holding-dollar", texto: "Pgto na Entrega" }
  ],

  depoimentos: [
    { nome: "Lucas M.", texto: "Comprei meu iPhone 15 Pro lacrado, com NF e tudo certinho. Atendimento 10/10! Super recomendo a Top iPhones.", estrelas: 5, tempo: "2 semanas atras" },
    ...
    { nome: "Rafael O.", texto: "Melhor preco que encontrei em Angra. Parcela em 18x e o atendimento e nota mil!", estrelas: 5, tempo: "3 semanas atras" },
  ...
  faq: [
    ...
    { p: "Como funciona a entrega?", r: "Atendemos presencialmente na Rua da Conceicao, 309, Angra dos Reis. Voce confere o produto na hora!" },
    { p: "Os seminovos tem garantia?", r: "Sim! Todos os seminovos passam por nossa inspecao completa e possuem garantia de funcionamento." },
    { p: "Posso pagar na entrega?", r: "Sim! Aceitamos pagamento via Pix, cartao ou dinheiro. Voce so paga quando conferir o produto." }
  ],
