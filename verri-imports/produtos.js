...
const LOJA = {
  ...
  slogan: "Especialistas em iPhones com 3 lojas fisicas",
  descricao: "iPhones, JBL e muito mais. 3 lojas fisicas: Volta Redonda, Barra Mansa e Resende. Aceitamos troca.",
  instagram: "verri.imports",
  instagramUrl: "https://instagram.com/verri.imports",
  whatsapp: "5521999999999",
  whatsappLink: "https://wa.me/5521999999999",
  whatsappMsg: "Ola! Vi o catalogo online e tenho interesse em um produto!",
  seguidores: "48.9 mil",
  clientesSatisfeitos: "3.000+",
  cores: {primaria:"#00E5CC",secundaria:"#00BFA5",accent:"#64FFDA",grad1:"#00E5CC",grad2:"#00897B"},
  diferenciais: [{icone:"fa-store",texto:"3 Lojas Fisicas"},{icone:"fa-wrench",texto:"Assistencia Tecnica"},{icone:"fa-credit-card",texto:"Ate 18x"},{icone:"fa-mobile-screen",texto:"Aceitamos Troca"},{icone:"fa-shield-halved",texto:"Garantia"},{icone:"fa-users",texto:"Grupo VIP Ofertas"}],
  depoimentos: [
